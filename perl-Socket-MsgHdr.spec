...
%package man
Summary: man components for the perl-Socket-MsgHdr package.
Group: Default

%description man
man components for the perl-Socket-MsgHdr package.
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/x86_64-linux-thread-multi/Socket/MsgHdr.pm

%files lib
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/x86_64-linux-thread-multi/auto/Socket/MsgHdr/MsgHdr.so
